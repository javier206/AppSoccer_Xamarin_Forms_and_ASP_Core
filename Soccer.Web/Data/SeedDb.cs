...
namespace Soccer.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Leandro", "Páramo", "javierparamo206@gmail.com", "87898706", "Barrio 14 de abril", UserType.Admin);
            await CheckUserAsync("2020", "Juan", "Perez", "leosanjuan12890@gmail.com", "88888887", "Barrio 15 de abril", UserType.User);
            await CheckUserAsync("3030", "Jose", "Roque", "jos.roq@gmail.com", "88888888", "Barrio 16 de abril", UserType.User);
            await CheckUserAsync("4040", "Juan", "Moncada", "juanmon2480@gmail.com", "87878787", "Barrio 17 de abril", UserType.User);
